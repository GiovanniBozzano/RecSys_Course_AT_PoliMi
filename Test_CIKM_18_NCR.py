...
class MyTestCase(unittest.TestCase):
    ...
    def test_compute_item_score(self):
        recommender_instance, URM_train, URM_validation, URM_test, URM_negative = get_data_and_rec_instance(NCRWrapper)
    ...
    def test_save_and_load(self):
        ...
        recommender_instance_original, URM_train, URM_validation, URM_test, URM_negative = get_data_and_rec_instance(recommender_class)
        n_users, n_items = URM_train.shape
...
def get_data_and_rec_instance(recommender_class):
    ...
    return recommender_instance, URM_train, URM_validation, URM_test, URM_negative
