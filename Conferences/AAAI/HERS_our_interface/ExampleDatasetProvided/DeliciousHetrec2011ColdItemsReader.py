...
class DeliciousHetrec2011ColdItemsReader(object):
    URM_DICT = {}
    UCM_DICT = {}
    ICM_DICT = {}

    def __init__(self, pre_splitted_path):
        super(DeliciousHetrec2011ColdItemsReader, self).__init__()

        pre_splitted_path += "delicious_cs_items_data_split/"
        ...
        try:
            ...
            print("DeliciousHetrec2011ColdItemsReader: Pre-splitted data not found, building new one")

            users_net_path = original_data_path + "book_userNet.txt"
            items_net_path = original_data_path + "book_itemNet.txt"
            train_path = original_data_path + "book_rating_train_cold_item_reverse.txt"
            test_path = original_data_path + "book_rating_test_cold_item.txt"
            test_path_neg = original_data_path + "book_rating_test_cold_item_neg.txt"
            ...
            print("DeliciousHetrec2011ColdItemsReader: loading complete")
