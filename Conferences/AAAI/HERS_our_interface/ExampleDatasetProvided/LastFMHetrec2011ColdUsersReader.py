...
class LastFMHetrec2011ColdUsersReader(object):
    URM_DICT = {}
    UCM_DICT = {}
    ICM_DICT = {}

    def __init__(self, pre_splitted_path):
        super(LastFMHetrec2011ColdUsersReader, self).__init__()

        pre_splitted_path += "lastfm_cs_users_data_split/"
        ...
        try:
            ...
            print("LastFMHetrec2011ColdUsersReader: Attempting to load pre-splitted data")
            ...
            print("LastFMHetrec2011ColdUsersReader: Pre-splitted data not found, building new one")

            users_net_path = original_data_path + "lastfm_userNet.txt"
            items_net_path = original_data_path + "lastfm_itemNet.txt"
            train_path = original_data_path + "lastfm_rating_train_cold_user.txt"
            test_path = original_data_path + "lastfm_rating_test_cold_user.txt"
            test_path_neg = original_data_path + "lastfm_rating_test_cold_user_neg.txt"
            ...
            print("LastFMHetrec2011ColdUsersReader: loading complete")
