...
class DeliciousHetrec2011ColdUsersReader(object):
    URM_DICT = {}
    UCM_DICT = {}
    ICM_DICT = {}

    def __init__(self, pre_splitted_path):
        super(DeliciousHetrec2011ColdUsersReader, self).__init__()

        pre_splitted_path += "delicious_cs_users_data_split/"
        ...
        try:
            ...
            print("DeliciousHetrec2011ColdUsersReader: Pre-splitted data not found, building new one")
            ...
            print("DeliciousHetrec2011ColdUsersReader: loading complete")
